...
Shiny.addCustomMessageHandler('updateVisualizationDisplay', function (message) {
  ...
  loadingIndicators.forEach(indicator => {
    // We let the conditionalPanel handle the display style based on input$plot_status
    // Directly manipulating style here conflicts with conditionalPanel
    console.log(`[Visualization Sync][${pageId}] Status received: ${plotStatus}. ConditionalPanel should handle visibility.`);
    // if (plotStatus === 'loading') {
    //   // indicator.style.display = 'flex'; // REMOVED
    // } else {
