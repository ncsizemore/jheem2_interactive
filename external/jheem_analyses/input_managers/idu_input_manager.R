...
generate.iniation.numerators = function(data.type,
  ...
  file.dir = paste0("external/jheem_analyses/data_files/idu_initiation")
...
get.idu.availability.13.24 <- function(dir='external/jheem_analyses/data_files/idu_age_availability', years=2015:2018)
{
